 ...
 */
public class DirtyRootAllocator extends BaseAllocator {

  private final byte fillValue;

  public DirtyRootAllocator(final long limit, final byte fillValue) {
    super(null, "ROOT", BaseAllocator.configBuilder()
        .maxAllocation(limit).build());
    this.fillValue = fillValue;
  }

  @Override
  public ArrowBuf getEmpty() {
    return DefaultBufferAllocator.create().getEmpty();
  }
